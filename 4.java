...
class p4
{
  ...
  public static void main(String args[]) throws FileNotFoundException, IOException
  {
    ...
    gini[0] = ( giniOfCol[0]*totalOfCol[0] +
                 giniOfCol[1]*totalOfCol[1] )/(totalOfCol[0]+totalOfCol[1]);
           gini[1] = ( giniOfCol[2]*totalOfCol[2] +
                 giniOfCol[3]*totalOfCol[3] )/(totalOfCol[2]+totalOfCol[3]);
           gini[2] = ( giniOfCol[4]*totalOfCol[4] + giniOfCol[5]*totalOfCol[5]
                       + giniOfCol[6]*totalOfCol[6])/
                      (totalOfCol[4]+totalOfCol[5]+totalOfCol[6]);


      entropy[0] =  ( entropyOfCol[0]*totalOfCol[0] +
                  entropyOfCol[1]*totalOfCol[1] )/(totalOfCol[0]+totalOfCol[1]);
            entropy[1] = ( entropyOfCol[2]*totalOfCol[2] +
                  entropyOfCol[3]*totalOfCol[3] )/(totalOfCol[2]+totalOfCol[3]);
            entropy[2] = ( entropyOfCol[4]*totalOfCol[4] +
                  entropyOfCol[5]*totalOfCol[5] +  entropyOfCol[6]*totalOfCol[6])/
      (totalOfCol[4]+totalOfCol[5]+totalOfCol[6]);
