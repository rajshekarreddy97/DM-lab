...
public class prog3
{
  ...
  {
    BufferedReader csv = new BufferedReader(new FileReader(new File("/home/data3.csv")));
    ...
    for(String p:cl)
    {
      ...
      for(int i=0;i< (1<<n);i++)
      {
        ...
        if(temp3.length() !=0 && temp3.length() != 4)
        {
          ...
          if(count2 >0 && (count1/count2) >= confidence)
          {
            System.out.println(temp3 + "->" +temp4+ "Confidence: "+count1/count2);
          }
        }
      }
    }
